    ...
    <?php endif;?>
            ...
            <div class="activity-actions">
                ...
                <?php if(in_array($activity['Activity']['type'], array('photo','recommendation','experience')) && count($activity['Activity']['people_around']) > 1):?>
                    <a class="pull-left people-around" data-toggle="tooltip" title="<?php foreach ($activity['Activity']['people_around'] as $user) { echo $user['firstname'].' '.$user['lastname'].'<br/>';} ?>"><i class="fa fa-users"></i> <?php echo count($activity['Activity']['people_around']); ?> personnes sont dans cette ville</a> 
                <?php endif; ?>
