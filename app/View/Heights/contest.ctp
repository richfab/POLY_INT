...
=======
        <div class="col-md-4">
            <div class="well">
                <h2 id="how_to_participate">Comment participer ?</h2>
                        <?php if(AuthComponent::user('id')):?>
                <p><strong>1.</strong> <?= $this->Html->link('Télécharge','/paperplanes/paperplane_id='.AuthComponent::user('school_id').'.pdf') ;?> et imprime le patron en papier de l'avion de ton école avec les instructions de pliage.</p>
                        <?php else:?>
                <p><strong>1.</strong> <?= $this->Html->link('Télécharge',array('controller' => 'users', 'action' => 'login')) ;?> et imprime le patron de l'avion en papier de ton école avec les instructions de pliage.</p>
                        <?php endif;?>
