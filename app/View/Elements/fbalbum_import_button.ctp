...
<div class="fbalbum_import_button" experience_id="<?php echo $experience['Experience']['id']; ?>">
    <?php if($experience['Experience']['fbalbum_id'] !== NULL) : ?>
        <button class="btn btn-xs btn-default" onclick="if(confirm(__('Es-tu sûr de vouloir supprimer cet album ?')))delete_album(<?php echo $experience['Experience']['id']; ?>)"><?= __("Supprimer l'album");?></button>
