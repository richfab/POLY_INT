...
<?php
	...
	echo $this->Form->text('Search.query', array(
		'class' => 'query search-input form-control search-form',
		'value' => $value
	)); ?>
<?php echo $this->Form->submit(__d('api_generator', 'Search'), array('div' => false, 'class' => 'btn btn-info button red submit')); ?>
</fieldset>
